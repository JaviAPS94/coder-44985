...
describe('Testing de mascotas', () => {
    ...
    it('POST de /api/pets se debe corroborar que la mascota tenga el campo adopted en false', async () => {
        const petMock = {
    ...
    it('POST de /api/pets se debe corroborar que si no se envia el nombre debe retornar un bad request (400)', async () => {
        const petMock = {
            specie: 'Perro',
            birthDate: '10-10-2022'
        };
    ...
    it('GET de /api/pets se debe corroborar que la respuesta tiene los campos status y payload, además el payload debe ser de tipo arreglo', async () => {
    ...
    it('PUT de /api/pets se debe corroborar que se actualice correctamente la informacion de nuestra mascota', async () => {
        const petMock = {
            name: 'Patitas put',
            specie: 'Perro',
            birthDate: '10-10-2022'
    ...
    it('DELETE de /api/pets se debe corroborar que se elimine correctamente la ultima mascota agregada', async () => {
        const petMock = {
            name: 'Patitas delete',
            specie: 'Perro',
            birthDate: '10-10-2022'
